...
**EN**: IAM Bundle Render (IAM) — operationalizes `charter.checkpoint_iam` under the Charter
...
**中文**: IAM Bundle Render（IAM）。本 Skill 将 `charter.checkpoint_iam` 纳入治理框架，
...
```
list_skills --category=dev --id=dev_19
