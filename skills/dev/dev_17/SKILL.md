...
> **Skill ID / Skill 编号**: `dev_17`
> **Category / 分类**: `dev` — Development & Engineering / 开发与工程
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 6 / 阶段6
> **Module / 模块**: `charter.oncall_grpc_deliver`

---

## 职责 / Responsibility

**EN**: OnCall gRPC Deliver (OnCall) — operationalizes `charter.oncall_grpc_deliver` under the Charter
...
**中文**: OnCall gRPC Deliver（OnCall）。本 Skill 将 `charter.oncall_grpc_deliver` 纳入治理框架，
...
```
list_skills --category=dev --id=dev_17
