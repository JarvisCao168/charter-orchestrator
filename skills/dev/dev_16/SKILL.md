# Bidir mTLS Regression

> **Skill ID / Skill 编号**: `dev_16`
> **Category / 分类**: `dev` — Development & Engineering / 开发与工程
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 6 / 阶段6
> **Module / 模块**: `charter.spire_bidir_regression`

---

## 职责 / Responsibility

**EN**: Bidir mTLS Regression (SPIRE) — operationalizes `charter.spire_bidir_regression` under the Charter
...
**中文**: Bidir mTLS Regression（SPIRE）。本 Skill 将 `charter.spire_bidir_regression` 纳入治理框架，
...
```
list_skills --category=dev --id=dev_16
