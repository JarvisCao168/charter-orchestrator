# Checkpoint IAM Policy

> **Skill ID / Skill 编号**: `tst_10`
> **Category / 分类**: `test` — Testing & Verification / 测试与验证
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 7 / 阶段7
> **Module / 模块**: `charter.checkpoint_iam`

---

## 职责 / Responsibility

**EN**: Checkpoint IAM Policy (IAM) — operationalizes `charter.checkpoint_iam` under the Charter
...
**中文**: Checkpoint IAM Policy（IAM）。本 Skill 将 `charter.checkpoint_iam` 纳入治理框架，
...
```
list_skills --category=test --id=tst_10
