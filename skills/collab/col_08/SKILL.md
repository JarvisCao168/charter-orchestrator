...
> **Skill ID / Skill 编号**: `col_08`
> **Category / 分类**: `collab` — Collaboration & Memory / 协作与记忆
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 4 / 阶段4
> **Module / 模块**: `charter.memory_clustering`

---

## 职责 / Responsibility

**EN**: Memory Clustering (Memory) — operationalizes `charter.memory_clustering` under the Charter
...
**中文**: Memory Clustering（Memory）。本 Skill 将 `charter.memory_clustering` 纳入治理框架，
...
```
list_skills --category=collab --id=col_08
