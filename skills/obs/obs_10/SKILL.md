# AlertManager / PagerDuty Fire

> **Skill ID / Skill 编号**: `obs_10`
> **Category / 分类**: `obs` — Observability / 可观测性
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 7 / 阶段7
> **Module / 模块**: `charter.slo_alerts`

---

## 职责 / Responsibility

**EN**: AlertManager / PagerDuty Fire (SLO) — operationalizes `charter.slo_alerts` under the Charter
...
**中文**: AlertManager / PagerDuty Fire（SLO）。本 Skill 将 `charter.slo_alerts` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_10
