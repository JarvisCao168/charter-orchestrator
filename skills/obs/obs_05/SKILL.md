# Tempo Push & Aggregate

> **Skill ID / Skill 编号**: `obs_05`
...
**EN**: Tempo Push & Aggregate (OTel) — operationalizes `charter.trace_link` under the Charter
...
**中文**: Tempo Push & Aggregate（OTel）。本 Skill 将 `charter.trace_link` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_05
