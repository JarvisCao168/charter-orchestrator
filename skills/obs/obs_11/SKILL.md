# OnCall Routing Policy

> **Skill ID / Skill 编号**: `obs_11`
> **Category / 分类**: `obs` — Observability / 可观测性
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 7 / 阶段7
> **Module / 模块**: `charter.oncall_routing`

---

## 职责 / Responsibility

**EN**: OnCall Routing Policy (OnCall) — operationalizes `charter.oncall_routing` under the Charter
...
**中文**: OnCall Routing Policy（OnCall）。本 Skill 将 `charter.oncall_routing` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_11
