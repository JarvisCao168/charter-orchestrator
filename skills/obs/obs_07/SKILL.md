...
> **Skill ID / Skill 编号**: `obs_07`
> **Category / 分类**: `obs` — Observability / 可观测性
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 7 / 阶段7
> **Module / 模块**: `charter.prometheus_rules`

---

## 职责 / Responsibility

**EN**: Prometheus Alert Rules (Prometheus) — operationalizes `charter.prometheus_rules` under the Charter
...
**中文**: Prometheus Alert Rules（Prometheus）。本 Skill 将 `charter.prometheus_rules` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_07
