# OTel Export to Jaeger

> **Skill ID / Skill 编号**: `obs_03`
> **Category / 分类**: `obs` — Observability / 可观测性
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 7 / 阶段7
> **Module / 模块**: `charter.otel_export`

---

## 职责 / Responsibility

**EN**: OTel Export to Jaeger (OTel) — operationalizes `charter.otel_export` under the Charter
...
**中文**: OTel Export to Jaeger（OTel）。本 Skill 将 `charter.otel_export` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_03
