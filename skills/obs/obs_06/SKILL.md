...
> **Skill ID / Skill 编号**: `obs_06`
> **Category / 分类**: `obs` — Observability / 可观测性
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 7 / 阶段7
> **Module / 模块**: `charter.grafana`

---

## 职责 / Responsibility

**EN**: Grafana Dashboard Provision (Grafana) — operationalizes `charter.grafana` under the Charter
...
**中文**: Grafana Dashboard Provision（Grafana）。本 Skill 将 `charter.grafana` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_06
