# SLO Alert Gate & Payload

> **Skill ID / Skill 编号**: `obs_09`
...
**EN**: SLO Alert Gate & Payload (SLO) — operationalizes `charter.slo_alerts` under the Charter
...
**中文**: SLO Alert Gate & Payload（SLO）。本 Skill 将 `charter.slo_alerts` 纳入治理框架，
...
```
list_skills --category=obs --id=obs_09
