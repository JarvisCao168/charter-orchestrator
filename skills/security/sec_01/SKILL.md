...
> **Skill ID / Skill 编号**: `sec_01`
> **Category / 分类**: `security` — Security & Governance / 安全与治理
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 5 / 阶段5
> **Module / 模块**: `charter.x509_identity`

---

## 职责 / Responsibility

**EN**: X509 PKI Identity (X509 Identity) — operationalizes `charter.x509_identity` under the Charter
...
**中文**: X509 PKI Identity（X509 Identity）。本 Skill 将 `charter.x509_identity` 纳入治理框架，
...
```
list_skills --category=security --id=sec_01
