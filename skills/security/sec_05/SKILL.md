...
> **Skill ID / Skill 编号**: `sec_05`
> **Category / 分类**: `security` — Security & Governance / 安全与治理
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 5 / 阶段5
> **Module / 模块**: `charter.mtls`

---

## 职责 / Responsibility

**EN**: mTLS Trust Anchor (mTLS) — operationalizes `charter.mtls` under the Charter
...
**中文**: mTLS Trust Anchor（mTLS）。本 Skill 将 `charter.mtls` 纳入治理框架，
...
```
list_skills --category=security --id=sec_05
