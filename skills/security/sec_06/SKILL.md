# Bidirectional mTLS Context

> **Skill ID / Skill 编号**: `sec_06`
> **Category / 分类**: `security` — Security & Governance / 安全与治理
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 5 / 阶段5
> **Module / 模块**: `charter.spire_bidir_mtls`

---

## 职责 / Responsibility

**EN**: Bidirectional mTLS Context (mTLS) — operationalizes `charter.spire_bidir_mtls` under the Charter
...
**中文**: Bidirectional mTLS Context（mTLS）。本 Skill 将 `charter.spire_bidir_mtls` 纳入治理框架，
...
```
list_skills --category=security --id=sec_06
