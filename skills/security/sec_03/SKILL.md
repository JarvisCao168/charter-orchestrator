...
> **Skill ID / Skill 编号**: `sec_03`
> **Category / 分类**: `security` — Security & Governance / 安全与治理
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 5 / 阶段5
> **Module / 模块**: `charter.spiffe`

---

## 职责 / Responsibility

**EN**: SVID Issuance & Verification (SPIFFE) — operationalizes `charter.spiffe` under the Charter
...
**中文**: SVID Issuance & Verification（SPIFFE）。本 Skill 将 `charter.spiffe` 纳入治理框架，
...
```
list_skills --category=security --id=sec_03
