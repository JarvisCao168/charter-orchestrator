...
**EN**: SPIFFE Trust Domain (SPIFFE) — operationalizes `charter.spiffe` under the Charter
...
**中文**: SPIFFE Trust Domain（SPIFFE）。本 Skill 将 `charter.spiffe` 纳入治理框架，
...
```
list_skills --category=security --id=sec_02
