# Judge Pool K8s Deploy

> **Skill ID / Skill 编号**: `dep_08`
> **Category / 分类**: `deploy` — Delivery & Operations / 交付与运维
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 8 / 阶段8
> **Module / 模块**: `charter.judge_pool_deploy`

---

## 职责 / Responsibility

**EN**: Judge Pool K8s Deploy (Judge) — operationalizes `charter.judge_pool_deploy` under the Charter
...
**中文**: Judge Pool K8s Deploy（Judge）。本 Skill 将 `charter.judge_pool_deploy` 纳入治理框架，
...
```
list_skills --category=deploy --id=dep_08
