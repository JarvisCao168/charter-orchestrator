...
> **Skill ID / Skill 编号**: `dep_11`
> **Category / 分类**: `deploy` — Delivery & Operations / 交付与运维
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 8 / 阶段8
> **Module / 模块**: `charter.checkpoint_shared`

---

## 职责 / Responsibility

**EN**: Checkpoint S3 + Audit (S3) — operationalizes `charter.checkpoint_shared` under the Charter
...
**中文**: Checkpoint S3 + Audit（S3）。本 Skill 将 `charter.checkpoint_shared` 纳入治理框架，
...
```
list_skills --category=deploy --id=dep_11
