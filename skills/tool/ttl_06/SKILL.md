# Template PR Validate/Render

> **Skill ID / Skill 编号**: `ttl_06`
...
**EN**: Template PR Validate/Render (Template) — operationalizes `charter.template_pr` under the Charter
...
**中文**: Template PR Validate/Render（Template）。本 Skill 将 `charter.template_pr` 纳入治理框架，
...
```
list_skills --category=tool --id=ttl_06
