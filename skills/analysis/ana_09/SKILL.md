# Judge Concurrency + Cache

> **Skill ID / Skill 编号**: `ana_09`
> **Category / 分类**: `analysis` — Analysis & Decision / 分析与决策
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 1 / 阶段1
> **Module / 模块**: `charter.judge_concurrency`

---

## 职责 / Responsibility

**EN**: Judge Concurrency + Cache (Judge) — operationalizes `charter.judge_concurrency` under the Charter
...
**中文**: Judge Concurrency + Cache（Judge）。本 Skill 将 `charter.judge_concurrency` 纳入治理框架，
...
```
list_skills --category=analysis --id=ana_09
