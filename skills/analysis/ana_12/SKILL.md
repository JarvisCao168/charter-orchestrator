# Cluster Naming (Heuristic/LLM)

> **Skill ID / Skill 编号**: `ana_12`
> **Category / 分类**: `analysis` — Analysis & Decision / 分析与决策
> **Trigger / 触发方式**: Auto / 自动
> **Stage / 适用阶段**: Stage 1 / 阶段1
> **Module / 模块**: `charter.cluster_naming`

---

## 职责 / Responsibility

**EN**: Cluster Naming (Heuristic/LLM) (Cluster) — operationalizes `charter.cluster_naming` under the Charter
...
**中文**: Cluster Naming (Heuristic/LLM)（Cluster）。本 Skill 将 `charter.cluster_naming` 纳入治理框架，
...
```
list_skills --category=analysis --id=ana_12
